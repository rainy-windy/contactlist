                        ...
                        child: Row(
                            ...
                            children: [
                              ...
                              Expanded(
                                  flex: 4,
                                  child: InkWell(
                                    child: Gesture(caption: 'Star', colourStart: const Color(0xFFFCE4EC), colourEnd: Theme.of(context).secondaryHeaderColor, icon: favlist.contains(_person!.mobileNumber)? const Icon(Icons.star) : const Icon(Icons.star_border), stretch: _height),
                                    onTap: () {
                                      setState(() => _height = 56);
